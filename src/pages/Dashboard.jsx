  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-sm font-medium text-gray-500">Total de Créditos</h3>
          <p className="mt-2 text-3xl font-semibold text-gray-900">{stats.totalCredits}</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-sm font-medium text-gray-500">Créditos Utilizados</h3>
          <p className="mt-2 text-3xl font-semibold text-green-600">{stats.usedCredits}</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-sm font-medium text-gray-500">Créditos Disponíveis</h3>
          <p className="mt-2 text-3xl font-semibold text-blue-600">{stats.availableCredits}</p>
        </div>
      </div>
